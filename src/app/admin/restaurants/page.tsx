      ...
      <div className="mx-auto max-w-4xl space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <form action={updateRestaurant} className="grid gap-3 md:grid-cols-3">
                        ...
                        <div className="flex flex-wrap gap-2 md:col-span-3">
                          <button type="submit" className="rounded-lg bg-white px-3 py-2 text-sm font-medium text-black">
                            Зберегти
                          </button>
                        </div>
                      </form>
        ...
        <section className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm">
          ...
          <form action={createRestaurant} className="mt-4 grid gap-3 md:grid-cols-2">
            ...
            <button type="submit" className="mt-2 inline-flex w-fit rounded-lg bg-black px-4 py-2 text-sm font-medium text-white md:col-span-2">
              Створити ресторан
            </button>
          </form>
        </section>
