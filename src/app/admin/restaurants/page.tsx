...
import { createRestaurant, setActiveRestaurant } from "@/app/actions/restaurantManagementActions";
    ...
    <main className="min-h-screen bg-[#f7f7f8] px-4 py-10 md:px-8">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <section className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm">
          <h2 className="text-xl font-semibold text-black">Активний ресторан</h2>
            ...
            <ul className="mt-4 space-y-3">
              {restaurants.map((restaurant) => {
                ...
                return (
                  <li
                    key={restaurant.id}
                    className={`rounded-xl border p-4 ${isActive ? "border-black bg-black text-white" : "border-black/10 bg-[#f7f7f8] text-black"}`}
                  >
